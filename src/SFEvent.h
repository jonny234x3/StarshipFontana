 ...
 */
enum SFEVENT {SFEVENT_NULL, SFEVENT_QUIT, SFEVENT_UPDATE, SFEVENT_PLAYER_LEFT, SFEVENT_PLAYER_RIGHT, SFEVENT_PLAYER_UP, SFEVENT_PLAYER_DOWN, SFEVENT_FIRE_UP, SFEVENT_FIRE_LEFT, SFEVENT_FIRE_DOWN, SFEVENT_FIRE_RIGHT, SFEVENT_COLLISION, SFEVENT_LAST};
